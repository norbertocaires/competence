...
function competence_profile_tabs($a,&$b) {
	$temp = [
		...
		'url'   => System::baseUrl() . '/competencie/' . $b['nickname'],
		'sel'   => !$b['tab'] && $a->argv[0] == 'competencie' ? 'active' : '',
...
function competence_content($app) {
...
<form name="calc">
<!--
<TR><TD VALIGN=top colspan=6 ALIGN="center"> <H2>Competence</H2> </TD>
-->
<tbody><tr>
